//Plot several current dependecies (current of XrayTube vs peak position)
//Plot is saved as a .pdf file
//Please change the settings in the config file "PlotGraphCurrent.config"
...
//ein String anzupassen: L23

//void PlotGraphRate(TString configfile = "/home/koppen/Bachelorarbeit/Analyse/20150227_M0307-trimvcal35/20150227_M0307_respin-PlotGraphRate.config", 
//	       bool linearfit = true, bool plotlegend = true, bool verbose = true){
//void PlotGraphRate(TString configfile = "/home/rk/Dokumente/Universitaet/Bachelorarbeit/Analyse/20150227_M0307-trimvcal35/20150227_M0307_respin-PlotGraphRate.config", 
//	       bool linearfit = true, bool plotlegend = true, bool verbose = true){
void PlotGraphCurrent(TString configfile = "PlotGraphRate.config", 
       bool linearfit = true, bool plotlegend = true, bool verbose = true){
  ...
  TF1 *p1fit;
  fstream fc,df;  
  char *outputsave, *outputtxt, *legendtitle;
  ...
  if (verbose) cout << linecont << endl;
  fc >> min;
  if (verbose) cout << min << " bis ";
  fc >> max;
  if (verbose) cout << max << endl;
  fc.getline(linecont, 500);
  fc.getline(linecont, 500);
  ...
  multi->GetYaxis()->SetTitleOffset(0.65);
